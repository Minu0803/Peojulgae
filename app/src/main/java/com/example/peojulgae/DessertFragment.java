...
public class DessertFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_dessert_fragment, container, false);  // Ensure this matches your layout file name

        categoryItemsRecyclerView = view.findViewById(R.id.dessertRecyclerView);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot foodSnapshot : snapshot.getChildren()) {
                    ...
                    if (food != null && food.getCategories().contains("디저트")) {
                        foodList.add(food);
                    }
                }
