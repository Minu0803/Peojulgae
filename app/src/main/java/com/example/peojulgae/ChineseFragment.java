...
public class ChineseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_chinese_fragment, container, false);  // Ensure this matches your layout file name

        categoryItemsRecyclerView = view.findViewById(R.id.chineseRecyclerView);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot foodSnapshot : snapshot.getChildren()) {
                    ...
                    if (food != null && food.getCategories().contains("중식")) {
                        foodList.add(food);
                    }
                }
